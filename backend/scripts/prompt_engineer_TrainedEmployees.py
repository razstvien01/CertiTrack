...
def generate_prompt(result_list):
    ...
    Given all the project names give me the number of trained employees for every project where specific value (e.g., 'Passed').
    I only need the JSON list in this structure {{"ProjectName": "Project Name", "NumberOfTrainedEmployees": "Number of Trained Employees"}}
    """
...
if __name__ == "__main__":
    ...
    query = """SELECT PROJECT_NAME, COUNT(*) as num_trained_employees FROM database_table WHERE CURRENT_PROGRESS =='Passed' GROUP BY PROJECT_NAME ORDER BY num_trained_employees ASC"""
    ...
    ddl_file_path = 'backend/SQL/DDL/create_TrainedEmployees.sql'
