...
def generate_prompt(result_list):
    return f"""
    Refer to this dataset {result_list[0:100]}
    Who are the employees that name starts with letter "A"?
    I only need the JSON list in this structure [{{"FirstName": "First Name", "LastName": "Last Name"}}] and no other explanations. 
    """
...
if __name__ == "__main__":
    ...
    print(dml_statements)

    # Write DML statements to a file
    dml_file_name = f'generated_dml_for_{table_name}.sql'
    ...
    ddl_file_path = 'backend/SQL/DDL/create_Persons_Table.sql'
